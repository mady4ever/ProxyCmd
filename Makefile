...
STRIP = strip
VERSION = -
abs_builddir = /home/mahepate/libssh2/libssh2-1.6.0/example
abs_srcdir = /home/mahepate/libssh2/libssh2-1.6.0/example
abs_top_builddir = /home/mahepate/libssh2/libssh2-1.6.0
abs_top_srcdir = /home/mahepate/libssh2/libssh2-1.6.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/mahepate/libssh2/libssh2-1.6.0/install-sh
...
include ./$(DEPDIR)/direct_tcpip.Po
include ./$(DEPDIR)/scp.Po
include ./$(DEPDIR)/scp_nonblock.Po
include ./$(DEPDIR)/scp_write.Po
include ./$(DEPDIR)/scp_write_nonblock.Po
include ./$(DEPDIR)/sftp.Po
include ./$(DEPDIR)/sftp_RW_nonblock.Po
include ./$(DEPDIR)/sftp_append.Po
include ./$(DEPDIR)/sftp_mkdir.Po
include ./$(DEPDIR)/sftp_mkdir_nonblock.Po
include ./$(DEPDIR)/sftp_nonblock.Po
include ./$(DEPDIR)/sftp_write.Po
include ./$(DEPDIR)/sftp_write_nonblock.Po
include ./$(DEPDIR)/sftp_write_sliding.Po
include ./$(DEPDIR)/sftpdir.Po
include ./$(DEPDIR)/sftpdir_nonblock.Po
include ./$(DEPDIR)/ssh2.Po
include ./$(DEPDIR)/ssh2_agent.Po
include ./$(DEPDIR)/ssh2_echo.Po
include ./$(DEPDIR)/ssh2_exec.Po
include ./$(DEPDIR)/subsystem_netconf.Po
include ./$(DEPDIR)/tcpip-forward.Po
include ./$(DEPDIR)/x11.Po
